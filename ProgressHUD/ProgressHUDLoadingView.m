...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame])
    {
        ...
        [tip setText:ProgressHUDLoadingTip];
...
- (void)setAlpha:(CGFloat)alpha
{
    ...
    if (alpha == 0)
    {
        [_tip setText:ProgressHUDLoadingTip];
    }
}
...
{
    [_tip setText:tip==nil?ProgressHUDLoadingTip:tip];
}
@end
